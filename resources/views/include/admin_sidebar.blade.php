            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/student/category')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Student Category</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('admin/board')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Board</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/relationship')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Relationship</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('admin/nationality')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Nationality</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/blood-group')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Blood Group</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('admin/cast')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Cast</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{url('admin/marital-status')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Marital Status</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{url('admin/disability')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Disability</p>
                            </a>
                        </li>
