                            ...
                            <form role="form" action="{{url('admin/district/update')}}" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="district" value="{{ $district->dom_District}}" name="district" placeholder="Enter District"/>
                                    </div>
                                </div>
                                <!-- /.card-body -->
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{url('admin/district')}}" class="btn btn-warning">Back</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
