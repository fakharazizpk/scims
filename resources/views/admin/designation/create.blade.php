                            ...
                            <form role="form" action="{{url('admin/designation/add')}}" method="post">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" value="{{ old('designation')}}" name="designation" placeholder="Enter Designation"/>
                                        @error('designation')
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{url('admin/designation')}}" class="btn btn-warning">Cancel</a>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
