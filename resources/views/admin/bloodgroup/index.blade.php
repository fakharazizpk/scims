            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <a href="{{url('admin/blood-group/add-view')}}" class="btn btn-primary pull-right mb-1">Add Blood Group</a>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('admin/blood-group/delete/'.$blood_group->bg_Id)}}" class="btn btn-danger" onclick="return confirm('Are you sure?');"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
