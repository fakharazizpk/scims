                                            ...
                                            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="../../examples/pages/-employee-profile.html" class="btn btn-success btn-link btn-icon btn-sm fa fa-eye" title="View Profile"><i class="fa fa-times"></i></a>
                                                        <a href="../../examples/pages/add-staff.html" title="Edit" class="btn btn-warning btn-link btn-icon btn-sm edit"><i class="fa fa-edit"></i></a>
                                                        <a href="#" class="btn btn-danger btn-link btn-icon btn-sm remove" title="Withdraw"><i class="fa fa-times"></i></a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
