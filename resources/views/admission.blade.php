                                ...
                                <div class="tab-pane show active" id="admit">
                                    ...
                                    <div class="row bor-sep">
                                        ...
                                        <div class="col-sm-3 select-wizard">
                                            ...
                                            <select class="selectpicker" id="class" name="class_name" data-container="" data-size="3" data-style="btn btn-secondary" title="Select class" data-live-search="true"  data-hide-disabled="true">
                                    ...
                                    <div class=" pull-left">
                                        <input type="checkbox" name="student_status" value="Active" class=" fancy-check" id="myId"/>
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 select-wizard" >
                                                    <label>Gender</label>
                                                    <select class="selectpicker" name="student_gender" data-size="3" data-style="btn btn-secondary" title="Select Gender" >
                                                ...
                                                <div class="form-group col-sm-4">
                                                    ...
                                                    <input type="text" class="form-control datepicker" onchange="calculateAge();" id="std-date-of-birth" placeholder="" name="date_of_birth" >
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <label>Age</label>
                                                    <input type="text" class="form-control" placeholder="" id="std-age" name="age" number="true" readonly="true">
                                                </div>
                                                <div class="col-sm-4 select-wizard">
                                                ...
                                                <div class="form-group col-sm-4">
                                                    ...
                                                    <select class="selectpicker" name="student_district"    id="dom" data-container="" data-size="3" data-style="btn btn-secondary" title="Select domicile" data-live-search="true"  data-hide-disabled="true">
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <select class="selectpicker disability-dropdown" name="disability"  data-size="3" data-style="btn btn-secondary" title="Select If Disable" >
                                    ...
                                    <div class="row bor-sep">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="select-wizard form-group " >
                                                ...
                                                <select class="selectpicker col-sm-12 guardian-dropdown" name="guardian" id="guardian-dropdown" data-size="3" data-style="btn btn-secondary" title="Select Guardian" data-live-search="true" >
                                                    <option value="" disabled selected>Select Guardian</option>
                                                    @foreach($guardians as $guardian)
                                                        <option value="{{$guardian->pnt_Id}}">{{$guardian->pnt_Fname . " " .$guardian->pnt_Mname." " .$guardian->pnt_Lname}}</option>
                                                    @endforeach
                                            ...
                                            <div class="select-wizard form-group " >
                                                ...
                                                <select class="selectpicker col-sm-12" id="guardian-mother-dropdown" name="mother" data-container="" data-size="3" data-style="btn btn-secondary" title="Select Mother" data-live-search="true"  data-hide-disabled="true">
                                                    ...
                                                    @foreach($mothers as $mother)
                                                        <option value="{{$mother->pnt_Id}}">{{$mother->pnt_Fname . " " .$mother->pnt_Mname." " .$mother->pnt_Lname}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="tab-pane" id="stdacdm">
                                    ...
                                    <div class="row bor-sep">
                                        ...
                                        <div class="form-group col-sm-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="previous_school_name" >
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Previous School Contact No</label>
                                            <input type="text" class="form-control" placeholder="" name="previous_school_contact" number="true">
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Date of Leaving</label>
                                            <input type="text" class="form-control datepicker" placeholder="" name="previous_school_leaving_date" >
                                        </div>
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" name="previous_school_document" class="custom-file-input form-control" id="input-document" accept="image/*">
                                ...
                                <div class="tab-pane" id="pntcontact">
                                    <div class="row bor-sep">
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <textarea  class="form-control" name="parent_mailing_address" rows="1" cols="33"></textarea>
                                        </div>
                                        <div class="form-group col-sm-12">
                                            <label>Permanent Address</label>
                                            <textarea  class="form-control" name="parent_permanent_address" rows="1" cols="33"></textarea>
                                        </div>
                                        <div class=" col-sm-4 select-wizard">
                                            <label class="col-sm-12" >District</label>
                                            <select class="selectpicker"  id="parent_district" name="parent_district" data-container="" data-style="btn btn-secondary" data-size="3" data-style=" " title="Select district" data-live-search="true"  data-hide-disabled="true">
                                        ...
                                        <div class="select-wizard col-sm-4">
                                            ...
                                            <select class="selectpicker " id="parent_city" name="parent_city" data-container="" data-size="3" data-style="btn btn-secondary" title="Select city" data-live-search="true"  data-hide-disabled="true">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <label>Zip</label>
                                            <input type="text" class="form-control" placeholder="" name="parent_zipcode" >
                                        </div>
                                    </div>
                                    <div class="row bor-sep">
                                        ...
                                        <div class="form-group col-sm-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="" number="true" name="guardian_mobile" >
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Office Phone No</label>
                                            <input type="text" class="form-control" placeholder="" name="guardian_office_phone" number="true" >
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Home Phone No</label>
                                            <input type="text" class="form-control" placeholder="" name="guardian_home_phone" number="true">
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Email Address</label>
                                            <input type="text" class="form-control" placeholder="" name="guardian_email"  email="true">
                                        </div>
                                    </div>
                                    <div class="row bor-sep">
                                        ...
                                        <div class="form-group col-sm-3">
                                            <label>Mobile Phone No</label>
                                            <input type="text" class="form-control" placeholder="" name="mother_mobile"  number="true">
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Office Phone No</label>
                                            <input type="text" class="form-control" placeholder="" name="mother_office_phone" number="true" >
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Home Phone No</label>
                                            <input type="text" class="form-control" placeholder="" name="mother_home_phone"  number="true">
                                        </div>
                                        <div class="form-group col-sm-3">
                                            <label>Email Address</label>
                                            <input type="text" class="form-control" placeholder="" name="mother_email"  email="true">
                                        </div>
                                    </div>
                                    <div class="row bor-sep">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="" name="student_emergency_name" >
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label>Contact No</label>
                                            <input type="text" class="form-control" placeholder="" name="student_emergency_phone" number="true" >
                                        </div>
                                        <div class="select-wizard col-sm-4">
                                            <label col-sm-12>Relationship with Student</label>
                                            <select class="selectpicker " id="relation_with_student" name="relation_with_student" data-container="" data-size="3" data-style="btn btn-secondary" title="Select relation" data-live-search="true"  data-hide-disabled="true">
            ...
            <div class="row">
                <div class="modal-content">
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-sm-9 ">
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-sm-4">
                                    <label>First Name</label>
                                    <input type="text" class="form-control" placeholder="" name="guardian_first_name" required>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>Middle Name</label>
                                    <input type="text" class="form-control" placeholder="" name="guardian_middle_name" required>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>Last Name</label>
                                    <input type="text" class="form-control" placeholder="" name="guardian_last_name" required>
                                </div>

                                <div class="col-sm-4 select-wizard" >
                                    <label>Gender</label>
                                    <select class="selectpicker" name="guardian_gender" data-size="3" data-style="btn btn-secondary" title="Select Gender" required>
                                        <option value="" disabled selected>Select Gender</option>
                                        @foreach($genders as $gender)
                                            <option value="{{$gender->gnd_Id}}" selected="selected">{{$gender->gender}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-sm-4">
                                    <label>National Identifier</label>
                                    <input type="text" class="form-control" placeholder="" name="guardian_cnic"  number="true" required>
                                </div>
                                <div class=" col-sm-4 select-wizard">
                                    <label>Relation</label>
                                    <select class="selectpicker " name="guardian_relation" id="guardrelation" data-container="" data-size="3" required data-style="btn btn-secondary" title="Select relation" data-live-search="true"  data-hide-disabled="true">
                                ...
                                <div class=" col-sm-4 select-wizard">
                                    ...
                                    <select class="selectpicker " name="guardian_occupation" id="guard-occupation" data-container="" data-size="3" required data-style="btn btn-secondary" title="Select relation" data-live-search="true"  data-hide-disabled="true">
                                        <option value="" disabled >Select Relation</option>
                                ...
                                <div class=" col-sm-4 select-wizard">
                                    ...
                                    <select class="selectpicker " name="guardian_designation" id="guardian-designation" data-container="" data-size="3" required data-style="btn btn-secondary" title="Select relation" data-live-search="true"  data-hide-disabled="true">
                                        <option value="" disabled >Select Relation</option>
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="guardian_employer" required>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <div class="">
                            <button type="button" class="btn btn-success btn-link save-guardian-modal-btn"  id="save-guardian-modal-btn">Save</button>
                        </div>
                        <div class="divider"></div>
                        <div class="">
...
<div class="modal fade " id="mymother-modal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl  modal-dialog-centered">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 select-wizard" >
                            <label>Gender</label>
                            <select class="selectpicker" name="mother_gender" data-size="3" data-style="btn btn-secondary" title="Select Gender" required>
                                <option value="" disabled selected>Select Gender</option>
                                @foreach($genders as $gender)
                                    <option value="{{$gender->gnd_Id}}">{{$gender->gender}}</option>
                                @endforeach
                        ...
                        <div class="input-field col-sm-4">
                            ...
                            <select class="selectpicker" name="mother_marital_status" data-size="3" data-style="btn btn-secondary" title="If Living Separated" >
                        ...
                        <div class="select-wizard col-sm-4">
                            ...
                            <select class="selectpicker" name="mother_working_status" data-size="3" data-style="btn btn-secondary" title="Select Status" >
                        ...
                        <div class=" col-sm-4 select-wizard">
                            <label>Relation</label>
                            <select class="selectpicker " name="mother_relation" id="guardrelation" data-container="" data-size="3" required data-style="btn btn-secondary" title="Select relation" data-live-search="true"  data-hide-disabled="true">
                                <option value="" disabled >Select Relation</option>
                                @foreach($ralationship as $ralation)
                                    <option value="{{$ralation->pk_relat_Id}}">{{$ralation->relation_Name}}</option>
                                @endforeach
                        ...
                        <div class=" col-sm-4 select-wizard">
                            <label>Occupation</label>
                            <select class="selectpicker " name="mother_occupation" id="mother-occupation" data-container="" data-size="3" required data-style="btn btn-secondary" title="Select relation" data-live-search="true"  data-hide-disabled="true">
                                <option value="" disabled >Select Relation</option>
                                @foreach($occupations as $occupation)
                                    <option value="{{$occupation->occup_Id}}">{{$occupation->occup_Name}}</option>
                                @endforeach
                        ...
                        <div class=" col-sm-4 select-wizard">
                            <label>Designation</label>
                            <select class="selectpicker " name="mother_designation" id="mother-designation" data-container="" data-size="3" required data-style="btn btn-secondary" title="Select relation" data-live-search="true"  data-hide-disabled="true">
                                <option value="" disabled >Select Relation</option>
                                @foreach($designations as $designation)
                                    <option value="{{$designation->desig_Id}}">{{$designation->designation}}</option>
                                @endforeach
            ...
            <div class="modal-footer">
                <div class="">
                    <button type="button" class="btn btn-success btn-link add-mother-save-btn"  id="add-mother-save-btn">Save</button>
                </div>
                <div class="divider"></div>
                <div class="">
                    <button type="button" class="btn btn-danger btn-link" data-dismiss="modal">Cancel</button>
