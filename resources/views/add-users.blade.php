                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 pull-right">
                                    <button class="btn btn-secondary pull-right" data-toggle="modal" data-target="#user-modal" id="show-user-btn">
                                        Add New User
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="edit-user-modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body row">
                                            <div class="col-sm-4">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        <label>Given Name</label>
                                                        <input type="text" class="form-control" placeholder="" name="given_name" required="true" id="edit-name"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="form-group col-sm-6">
                                                        <label>Username</label>
                                                        <input type="text" class="form-control" placeholder="" name="username" required="true" id="edit-username" />
                                                    </div>
                                                    <div class="form-group col-sm-6 select-wizard">
                                                        <label>Password *</label>
                                        ...
                                        <div class="modal-footer">
                                            <div class="">
                                                <button type="submit" class="btn btn-success btn-link" id="edit-save-btn">Save</button>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="">
                                                <button type="button" class="btn btn-danger btn-link" data-dismiss="modal">Cancel</button>
                            ...
                            <div class="modal fade" id="show-user-modal" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-sm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <div class="">
                                                <button type="submit" class="btn btn-success btn-link" data-dismiss="modal" id="show-save-btn">Save</button>
                                            </div>
                                            <div class="divider"></div>
                                            <div class="">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="col-lg-6 col-md-6  col-sm-1">
                                                        <div class="dropdown ">
                                                            <button style="margin-left: 50px" class="dropdown-toggle btn btn-secondary" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                Manage
                                                            </button>
